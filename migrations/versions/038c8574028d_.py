...
Revision ID: 038c8574028d
Revises: 
Create Date: 2021-08-23 00:05:07.164534
...
def upgrade():
    ...
    sa.Column('idExtra', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['idDesafio'], ['desafios.id'], ),
    sa.ForeignKeyConstraint(['idExtra'], ['extras.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
